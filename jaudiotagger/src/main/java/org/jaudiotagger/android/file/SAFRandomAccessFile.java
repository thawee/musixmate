...
package org.jaudiotagger.android.file;
 ...
 */
public class SAFRandomAccessFile implements DataOutput, DataInput, Closeable {
    ...
    public SAFRandomAccessFile(File file, String mode) throws FileNotFoundException {
        this(new DataStoreEntry(file.getAbsolutePath(),false), isReadOnly(mode));
    }
     ...
     *      for writing
     */
    public SAFRandomAccessFile(DataStoreEntry entry, boolean readOnly)
