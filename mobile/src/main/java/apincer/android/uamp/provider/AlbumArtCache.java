...
public final class AlbumArtCache {
    ...
    private MediaProvider mTagHelper;
    ...
    private static final int MAX_ART_WIDTH_ICON = 128; //128;  // pixels
    private static final int MAX_ART_HEIGHT_ICON = 128; //128;  // pixels
    ...
    public static AlbumArtCache getInstance(MediaProvider mTagHelper) {
        if(sInstance.mTagHelper==null) {
            sInstance.mTagHelper = mTagHelper;
        }
        return sInstance;
    }
        ...
        new AsyncTask<Void, Void, Bitmap[]>() {
            ...
            protected Bitmap[] doInBackground(Void[] objects) {
                ...
                try {
                    ...
                    //Bitmap bitmap = mTagHelper.getArtwork(artUrl);
                    Bitmap bitmap = mTagHelper.getArtwork(null);
