...
public class UsbDocumentFile extends DocumentFile {
    ...
    public DocumentFile createFile(String mimeType, String displayName) {
        Uri result = null;
        try {
            result = DocumentsContractCompat.createFile(mContext, mUri, mimeType, displayName);
    ...
    public DocumentFile createDirectory(String displayName) {
        Uri result = null;
        try {
            result = DocumentsContractCompat.createDirectory(mContext, mUri, displayName);
        } catch (FileNotFoundException fnf) {
            result = null;
        }
        return (result != null) ? new UsbDocumentFile(this, mContext, result) : null;
    ...
    public boolean renameTo(String displayName) {
        Uri result  = null;
        try {
            result = DocumentsContractCompat.renameTo(mContext, mUri, displayName);
        } catch (FileNotFoundException fnf) {
            result = null;
        }
        if (result != null) {
