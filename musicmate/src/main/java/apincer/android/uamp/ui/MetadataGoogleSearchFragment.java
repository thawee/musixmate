...
public class MetadataGoogleSearchFragment extends Fragment {
    private WebView webView;
    private Filter mFilter;
    private String keyword;
    private List<Tag> tags = new ArrayList();
    public static String SEACH_URL = "http://www.google.com/search?source=lnms&sa=X&q=";
